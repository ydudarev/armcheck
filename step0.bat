@echo off
    ...
    ipconfig >> C:\tmp\%COMPUTERNAME%_result.txt
    tcping -d -n 10 msk-fcc-vpn.tech.nis-glonass.ru 80 >> C:\tmp\%COMPUTERNAME%_result.txt
    tcping -d -n 10 msk-fcc-vpn.tech.nis-glonass.ru 5060 >> C:\tmp\%COMPUTERNAME%_result.txt
